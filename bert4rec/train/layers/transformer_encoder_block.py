...
class RMSNorm(tf.keras.layers.Layer):
  ...
  def build(self, input_shape: Union[tf.TensorShape, Sequence[Optional[int]]]):
...
class TransformerEncoderBlock(tf.keras.layers.Layer):
  ...
  def __init__(self,
    ...
    if attention_initializer:
      ...
      self._attention_initializer = utils.clone_initializer(
  ...
  def build(self, input_shape):
    ...
    attention_layer_kwargs = dict(
        ...
        bias_initializer=utils.clone_initializer(self._bias_initializer),
    ...
    self._intermediate_dense = tf.keras.layers.EinsumDense(
        ...
        bias_axes="d",
        kernel_initializer=utils.clone_initializer(self._kernel_initializer),
        bias_initializer=utils.clone_initializer(self._bias_initializer),
        name="intermediate",
        **common_kwargs)
  ...
  def get_config(self):
    config = {
        ...
        "kernel_initializer": utils.serialize_initializer(
            self._kernel_initializer, use_legacy_format=True
        ),
        "bias_initializer": utils.serialize_initializer(
            self._bias_initializer, use_legacy_format=True
        ),
        "kernel_regularizer": utils.serialize_regularizer(
            self._kernel_regularizer, use_legacy_format=True
        ),
        "bias_regularizer": utils.serialize_regularizer(
            self._bias_regularizer, use_legacy_format=True
        ),
        "activity_regularizer": utils.serialize_regularizer(
            self._activity_regularizer, use_legacy_format=True
        ),
        "kernel_constraint": utils.serialize_constraint(
            self._kernel_constraint, use_legacy_format=True
        ),
        "bias_constraint": utils.serialize_constraint(
        ...
        "attention_initializer": utils.serialize_initializer(
